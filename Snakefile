...
def get_counts_and_meta(wildcards):
    ...
    counts_file = metadata_df.loc[metadata_df['accession'].isin([accession]), 'count_file'].to_list()
    meta_file = metadata_df.loc[metadata_df['accession'].isin([accession]), 'meta_file'].to_list()
